 ...
 */
export class CreateCustomer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    this.displayOptions = this.displayOptions.bind(this); //sets what is displayed to the user
  }
  ...
  displayOptions(displayType, customerInfo) {
  ...
  render() {
    ...
    if (this.props.modal === true) {
      //if its in a modal
      display = this.displayOptions("modal"); //display is rendered as a quick create component
    } else {
      display = this.displayOptions(this.props.appType); //display is rendered based on the application type
    }
